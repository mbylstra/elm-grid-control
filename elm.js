...
Elm.Css.make = function (_elm) {
   ...
   var stringsToValue = function (list) {
      return $List.isEmpty(list) ? {value: "none"} : {value: A2($String.join,
      ", ",
      A2($List.map,function (s) {    return s;},list))};
   };
   var valuesOrNone = function (list) {
      return $List.isEmpty(list) ? {value: "none"} : {value: A2($String.join,
      " ",
      A2($List.map,function (_) {    return _.value;},list))};
   };
   var stringToInt = function (str) {
      return A2($Result.withDefault,0,$String.toInt(str));
   };
   ...
   var numericalPercentageToString = function (value) {
      ...
      "%",
      numberToString(A2(F2(function (x,y) {    return x * y;}),
      100,
      value)));
   };
   var each = F2(function (snippetCreators,mixins) {
      ...
      $Css$Preprocess.unwrapSnippet,
      A2($List.map,
      F2(function (x,y) {    return y(x);})(_U.list([])),
      snippetCreators))));
   });
   ...
   var withClass = function ($class) {
      return $Css$Preprocess.ExtendSelector($Css$Structure.ClassSelector(A2($Css$Helpers.identifierToString,
      "",
      $class)));
   };
   ...
   var directionalityToString = function (directionality) {
   ...
   var propertyWithWarnings = F3(function (warnings,key,value) {
      return $Css$Preprocess.AppendProperty({key: key
                                            ,value: value
                                            ,important: false
                                            ,warnings: warnings});
   });
   ...
   _op["."] = F2(function ($class,mixins) {
      ...
      mixins,
      $Css$Structure.UniversalSelectorSequence(_U.list([$Css$Structure.ClassSelector(A2($Css$Helpers.identifierToString,
      "",
      $class))])));
   });
   var selector = F2(function (selectorStr,mixins) {
      return A2(makeSnippet,
      mixins,
      A2($Css$Structure.CustomSelector,selectorStr,_U.list([])));
   });
   var everything = function (mixins) {
      return A2(makeSnippet,
      mixins,
      $Css$Structure.UniversalSelectorSequence(_U.list([])));
   };
   _op["#"] = F2(function (id,mixins) {
      return A2(makeSnippet,
      mixins,
      $Css$Structure.UniversalSelectorSequence(_U.list([$Css$Structure.IdSelector(A2($Css$Helpers.identifierToString,
      "",
      id))])));
   });
   ...
   var animationNames = function (identifiers) {
      ...
      ", ",
      A2($List.map,$Css$Helpers.identifierToString(""),identifiers));
      return A2(property,"animation-name",value);
   };
   var animationName = function (identifier) {
      return animationNames(_U.list([identifier]));
   };
   var fontWeight = function (_p3) {
      ...
      var validWeight = function (weight) {
         return !_U.eq(_p5,
         $Basics.toString(weight)) ? true : A2($List.member,
         weight,
         A2($List.map,
         F2(function (x,y) {    return x * y;})(100),
         _U.range(1,9)));
      };
   ...
   var fontFeatureSettingsList = function (featureTagValues) {
      var warnings = $List.concat(A2($List.map,
      function (_) {
         return _.warnings;
      },
      featureTagValues));
   ...
   var fontFeatureSettings = function (_p6) {
      var _p7 = _p6;
      return A3(propertyWithWarnings,
      _p7.warnings,
      "font-feature-settings",
   ...
   var fontFace = function (value) {
      return A2($Basics._op["++"],"font-face ",value);
   };
   var src = function (value) {
      return $Basics.toString(value.value);
   };
   ...
   var media = F2(function (mediaQueries,snippets) {
            ...
            if (_p8.ctor === "[]") {
                  ...
                  {case "StyleBlockDeclaration": var _v7 = _p8._1;
                     ...
                     case "MediaRule": return A2($List._op["::"],
                       A2($Css$Preprocess.MediaRule,
                       A2($Basics._op["++"],mediaQueries,_p8._0._0),
                       _p8._0._1),
      ...
      var snippetDeclarations = A2($List.concatMap,
      $Css$Preprocess.unwrapSnippet,
      snippets);
      var mediaRuleFromStyleBlocks = A2($Css$Preprocess.MediaRule,
      mediaQueries,
      extractStyleBlocks(snippetDeclarations));
      return $Css$Preprocess.Snippet(A2($List._op["::"],
   ...
   var prop4 = F5(function (key,argA,argB,argC,argD) {
      ...
      A2($String.join,
      " ",
      _U.list([argA.value,argB.value,argC.value,argD.value])));
   });
   ...
   var prop3 = F4(function (key,argA,argB,argC) {
      return A2(property,
      key,
      A2($String.join,
      " ",
      _U.list([argA.value,argB.value,argC.value])));
   });
   ...
   var textDecorations3 = function (_p10) {
      return A2(prop3,"text-decoration",valuesOrNone(_p10));
   };
   var prop2 = F3(function (key,argA,argB) {
      return A2(property,
      key,
      A2($String.join," ",_U.list([argA.value,argB.value])));
   });
   ...
   var textDecorations2 = function (_p11) {
      return A2(prop2,"text-decoration",valuesOrNone(_p11));
   };
   var prop1 = F2(function (key,arg) {
      return A2(property,key,arg.value);
   });
   ...
   var fontFamilies = function (_p12) {
      return A2(prop1,"font-family",stringsToValue(_p12));
   };
   ...
   var fontVariantNumerics = function (_p13) {
      return A2(prop1,"font-variant-numeric",valuesOrNone(_p13));
   };
   var textDecoration = prop1("text-decoration");
   var textDecorations = function (_p14) {
      return A2(prop1,"text-decoration",valuesOrNone(_p14));
   };
   var textDecorationLine = prop1("text-decoration-line");
   var textDecorationLines = function (_p15) {
      return A2(prop1,"text-decoration-line",valuesOrNone(_p15));
   };
   ...
   var transforms = function (_p16) {
      return A2(prop1,"transform",valuesOrNone(_p16));
   };
   var transform = function (only) {
      return transforms(_U.list([only]));
   };
   ...
   var NonMixable = {};
   var important = $Css$Preprocess.mapLastProperty(function (property) {
      return _U.update(property,{important: true});
   });
   var all = prop1("all");
   ...
   var combineLengths = F3(function (operation,first,second) {
      ...
      _U.list([$Basics.toString(A2(operation,
              first.numericValue,
              second.numericValue))
              ,first.unitLabel])));
      return _U.update(first,{value: value});
   });
   _op["|*|"] = combineLengths(F2(function (x,y) {
      return x * y;
   }));
   _op["|/|"] = combineLengths(F2(function (x,y) {
      return x / y;
   ...
   var NumberedWeight = F2(function (a,b) {
      return {value: a,fontWeight: b};
   });
   var getOverloadedProperty = F3(function (functionName,
   desiredKey,
   mixin) {
      getOverloadedProperty: while (true) {
         var _p18 = mixin;
         switch (_p18.ctor)
         {case "AppendProperty": return A2(property,
              desiredKey,
              _p18._0.key);
            ...
            default: if (_p18._0.ctor === "[]") {
                    ...
                    _U.list([A2($Basics._op["++"],
                    "Cannot apply ",
                    A2($Basics._op["++"],functionName," with empty mixin. "))]),
                    desiredKey,
                    "");
                 } else {
                    if (_p18._0._1.ctor === "[]") {
                          ...
                          _v15 = desiredKey,
                          _v16 = $Css$Preprocess.ApplyMixins(_p18._0._1);
                          functionName = _v14;
                          desiredKey = _v15;
                          mixin = _v16;
                          continue getOverloadedProperty;
   ...
   var cssFunction = F2(function (funcName,args) {
      ...
      A2($Basics._op["++"],
      "(",
      A2($Basics._op["++"],A2($String.join,", ",args),")")));
   });
   ...
   var PseudoElement = F2(function (a,b) {
      return {ctor: "PseudoElement",_0: a,_1: b};
   });
   var PseudoClass = F2(function (a,b) {
   ...
   var transparent = {value: "transparent"
                     ,color: Compatible
                     ,warnings: _U.list([])};
   var currentColor = {value: "currentColor"
                      ,color: Compatible
                      ,warnings: _U.list([])};
   ...
   var rgb = F3(function (red,green,blue) {
      var warnings = _U.cmp(red,0) < 0 || (_U.cmp(red,
      255) > 0 || (_U.cmp(green,0) < 0 || (_U.cmp(green,
      255) > 0 || (_U.cmp(blue,0) < 0 || _U.cmp(blue,
      ...
      ") is not valid."))))))]) : _U.list([]);
      return {value: A2(cssFunction,
             "rgb",
             A2($List.map,numberToString,_U.list([red,green,blue])))
             ,color: Compatible
             ,warnings: warnings
             ,red: red
             ,green: green
   ...
   var rgba = F4(function (red,green,blue,alpha) {
      ...
      255) > 0 || (_U.cmp(green,0) < 0 || (_U.cmp(green,
      255) > 0 || (_U.cmp(blue,0) < 0 || (_U.cmp(blue,
      255) > 0 || (_U.cmp(alpha,0) < 0 || _U.cmp(alpha,
      1) > 0)))))) ? _U.list([A2($Basics._op["++"],
      ...
      return {value: A2(cssFunction,
             "rgba",
             A2($List.map,numberToString,_U.list([red,green,blue,alpha])))
             ,color: Compatible
             ,warnings: warnings
             ,red: red
             ,green: green
   ...
   var hex = function (str) {
      return {value: A2($Basics._op["++"],"#",str)
             ,color: Compatible
             ,red: 0
             ,green: 0
             ,blue: 0
   ...
   var hslaToRgba = F6(function (value,
   warnings,
   hue,
   saturation,
   lightness,
   ...
   var hsl = F3(function (hue,saturation,lightness) {
      var valuesList = _U.list([numberToString(hue)
                               ,numericalPercentageToString(saturation)
                               ,numericalPercentageToString(lightness)]);
      var value = A2(cssFunction,"hsl",valuesList);
      var warnings = _U.cmp(hue,360) > 0 || (_U.cmp(hue,
      0) < 0 || (_U.cmp(saturation,1) > 0 || (_U.cmp(saturation,
      0) < 0 || (_U.cmp(lightness,1) > 0 || _U.cmp(lightness,
      0) < 0)))) ? _U.list([A2($Basics._op["++"],
   ...
   var optimizeSpeed = {value: "optimizeSpeed"
                       ,textRendering: Compatible};
   var optimizeLegibility = {value: "optimizeLegibility"
                            ,textRendering: Compatible};
   var geometricPrecision = {value: "geometricPrecision"
                            ,textRendering: Compatible};
   var hanging = {value: "hanging",textIndent: Compatible};
   var eachLine = {value: "each-line",textIndent: Compatible};
   var capitalize = {value: "capitalize"
   ...
   var dotted = {value: "dotted"
                ,borderStyle: Compatible
                ,textDecorationStyle: Compatible};
   var dashed = {value: "dashed"
                ,borderStyle: Compatible
                ,textDecorationStyle: Compatible};
   var solid = {value: "solid"
               ,borderStyle: Compatible
               ,textDecorationStyle: Compatible};
   ...
   var lengthForOverloadedProperty = A3(lengthConverter,
   IncompatibleUnits,
   "",
   0);
   var alignItems = function (fn) {
      return A3(getOverloadedProperty,
      "alignItems",
      "align-items",
      fn(lengthForOverloadedProperty));
   };
   var alignSelf = function (fn) {
      return A3(getOverloadedProperty,
      "alignSelf",
      "align-self",
      fn(lengthForOverloadedProperty));
   };
   var textAlignLast = function (fn) {
      return A3(getOverloadedProperty,
      "textAlignLast",
      "text-align-last",
      fn(lengthForOverloadedProperty));
   };
   var textAlign = function (fn) {
      return A3(getOverloadedProperty,
      "textAlign",
      "text-align",
      fn(lengthForOverloadedProperty));
   };
   var verticalAlign = function (fn) {
      return A3(getOverloadedProperty,
      "verticalAlign",
      "vertical-align",
      fn(lengthForOverloadedProperty));
   ...
   var angleConverter = F2(function (suffix,num) {
      return {value: A2($Basics._op["++"],
             numberToString(num),
             suffix)
             ,angle: Compatible};
   ...
   var matrix = F6(function (a,b,c,d,tx,ty) {
      return {value: A2(cssFunction,
             "matrix",
             A2($List.map,numberToString,_U.list([a,b,c,d,tx,ty])))
                                             ...
                                             return function (d3) {
                                                return function (d4) {
                                                   return {value: A2(cssFunction,
                                                          ...
                                                          A2($List.map,
                                                          numberToString,
                                                          _U.list([a1,a2,a3,a4,b1,b2,b3,b4,c1,c2,c3,c4,d1,d2,d3,d4])))
                                                          ,transform: Compatible};
                                                };
                                             };
                                          };
   ...
   var perspective = function (l) {
      return {value: A2(cssFunction,
             "perspective",
             _U.list([numberToString(l)]))
             ,transform: Compatible};
   };
   var rotate = function (_p19) {
      var _p20 = _p19;
      return {value: A2(cssFunction,"rotate",_U.list([_p20.value]))
             ,transform: Compatible};
   };
   var rotateX = function (_p21) {
      var _p22 = _p21;
      return {value: A2(cssFunction,"rotateX",_U.list([_p22.value]))
             ,transform: Compatible};
   };
   var rotateY = function (_p23) {
      var _p24 = _p23;
      return {value: A2(cssFunction,"rotateY",_U.list([_p24.value]))
             ,transform: Compatible};
   };
   var rotateZ = function (_p25) {
      var _p26 = _p25;
      return {value: A2(cssFunction,"rotateZ",_U.list([_p26.value]))
             ,transform: Compatible};
   };
   var rotate3d = F4(function (x,y,z,_p27) {
      var _p28 = _p27;
      var coordsAsStrings = A2($List.map,
      numberToString,
      _U.list([x,y,z]));
      return {value: A2(cssFunction,
             "rotate3d",
             A2($Basics._op["++"],coordsAsStrings,_U.list([_p28.value])))
             ,transform: Compatible};
   });
   var scale = function (x) {
      return {value: A2(cssFunction,
             "scale",
             _U.list([numberToString(x)]))
             ,transform: Compatible};
   };
   var scale2 = F2(function (x,y) {
      return {value: A2(cssFunction,
             "scale",
             A2($List.map,numberToString,_U.list([x,y])))
             ,transform: Compatible};
   });
   ...
   var scaleY = function (y) {
      return {value: A2(cssFunction,
             "scaleY",
             _U.list([numberToString(y)]))
             ,transform: Compatible};
   };
   var scale3d = F3(function (x,y,z) {
      return {value: A2(cssFunction,
             "scale3d",
             A2($List.map,numberToString,_U.list([x,y,z])))
             ,transform: Compatible};
   });
   var skew = function (_p29) {
      var _p30 = _p29;
      return {value: A2(cssFunction,"skew",_U.list([_p30.value]))
             ,transform: Compatible};
   };
   var skew2 = F2(function (ax,ay) {
      return {value: A2(cssFunction,
             "skew",
             _U.list([ax.value,ay.value]))
             ,transform: Compatible};
   });
   var skewX = function (_p31) {
      var _p32 = _p31;
      return {value: A2(cssFunction,"skewX",_U.list([_p32.value]))
             ,transform: Compatible};
   };
   var skewY = function (_p33) {
      var _p34 = _p33;
      return {value: A2(cssFunction,"skewY",_U.list([_p34.value]))
             ,transform: Compatible};
   };
   var translate = function (_p35) {
      var _p36 = _p35;
      return {value: A2(cssFunction,"translate",_U.list([_p36.value]))
             ,transform: Compatible};
   };
   var translate2 = F2(function (tx,ty) {
      return {value: A2(cssFunction,
             "translate",
             _U.list([tx.value,ty.value]))
             ,transform: Compatible};
   });
   var translateX = function (_p37) {
      var _p38 = _p37;
      return {value: A2(cssFunction,
             "translateX",
             _U.list([_p38.value]))
   ...
   var translate3d = F3(function (tx,ty,tz) {
      return {value: A2(cssFunction,
             "translate3d",
             _U.list([tx.value,ty.value,tz.value]))
             ,transform: Compatible};
   });
   ...
   var preserve3d = {value: "preserve-3d"
   ...
   var underline = {value: "underline"
                   ,textDecorationLine: Compatible};
   var overline = {value: "overline"
                  ,textDecorationLine: Compatible};
   var lineThrough = {value: "line-through"
                     ,textDecorationLine: Compatible};
   ...
   var noWrap = {value: "nowrap"
                ,whiteSpace: Compatible
                ,flexWrap: Compatible
                ,flexDirectionOrWrap: Compatible};
   var fillAvailable = {value: "fill-available"
                       ,minMaxDimension: Compatible
                       ,lengthOrMinMaxDimension: Compatible
                       ,lengthOrNoneOrMinMaxDimension: Compatible};
   var maxContent = _U.update(fillAvailable,
   {value: "max-content"});
   var minContent = _U.update(fillAvailable,
   {value: "min-content"});
   var fitContent = _U.update(fillAvailable,
   {value: "fit-content"});
   ...
   var bold = {value: "bold"
              ,lengthOrNumberOrAutoOrNoneOrContent: Compatible};
   var lighter = {value: "lighter"
                 ,lengthOrNumberOrAutoOrNoneOrContent: Compatible};
   var bolder = {value: "bolder"
                ,lengthOrNumberOrAutoOrNoneOrContent: Compatible};
   var smallCaps = {value: "small-caps"
                   ,fontVariant: Compatible
                   ,fontVariantCaps: Compatible};
   var allSmallCaps = {value: "all-small-caps"
                      ,fontVariant: Compatible
                      ,fontVariantCaps: Compatible};
   var petiteCaps = {value: "petite-caps"
                    ,fontVariant: Compatible
                    ,fontVariantCaps: Compatible};
   var allPetiteCaps = {value: "all-petite-caps"
                       ,fontVariant: Compatible
                       ,fontVariantCaps: Compatible};
   var unicase = {value: "unicase"
                 ,fontVariant: Compatible
                 ,fontVariantCaps: Compatible};
   var titlingCaps = {value: "titling-caps"
                     ,fontVariant: Compatible
                     ,fontVariantCaps: Compatible};
   var commonLigatures = {value: "common-ligatures"
                         ,fontVariant: Compatible
                         ,fontVariantLigatures: Compatible};
   var noCommonLigatures = {value: "no-common-ligatures"
                           ,fontVariant: Compatible
                           ,fontVariantLigatures: Compatible};
   var discretionaryLigatures = {value: "discretionary-ligatures"
                                ,fontVariant: Compatible
                                ,fontVariantLigatures: Compatible};
   var noDiscretionaryLigatures = {value: "no-discretionary-ligatures"
                                  ,fontVariant: Compatible
                                  ,fontVariantLigatures: Compatible};
   var historicalLigatures = {value: "historical-ligatures"
                             ,fontVariant: Compatible
                             ,fontVariantLigatures: Compatible};
   var noHistoricalLigatures = {value: "no-historical-ligatures"
                               ,fontVariant: Compatible
                               ,fontVariantLigatures: Compatible};
   var contextual = {value: "context"
                    ,fontVariant: Compatible
                    ,fontVariantLigatures: Compatible};
   var noContextual = {value: "no-contextual"
                      ,fontVariant: Compatible
                      ,fontVariantLigatures: Compatible};
   var liningNums = {value: "lining-nums"
                    ,fontVariant: Compatible
                    ,fontVariantNumeric: Compatible};
   var oldstyleNums = {value: "oldstyle-nums"
                      ,fontVariant: Compatible
                      ,fontVariantNumeric: Compatible};
   var proportionalNums = {value: "proportional-nums"
                          ,fontVariant: Compatible
                          ,fontVariantNumeric: Compatible};
   var tabularNums = {value: "tabular-nums"
                     ,fontVariant: Compatible
                     ,fontVariantNumeric: Compatible};
   var diagonalFractions = {value: "diagonal-fractions"
                           ,fontVariant: Compatible
                           ,fontVariantNumeric: Compatible};
   var stackedFractions = {value: "stacked-fractions"
                          ,fontVariant: Compatible
                          ,fontVariantNumeric: Compatible};
   var ordinal = {value: "ordinal"
                 ,fontVariant: Compatible
                 ,fontVariantNumeric: Compatible};
   var slashedZero = {value: "slashed-zero"
                     ,fontVariant: Compatible
                     ,fontVariantNumeric: Compatible};
   var featureTag2 = F2(function (tag,value) {
      var potentialWarnings = _U.list([{ctor: "_Tuple2"
                                      ...
                                      ,{ctor: "_Tuple2"
                                       ...
                                       " is invalid."))}]);
      var warnings = A2($List.map,
      $Basics.snd,
      A2($List.filter,$Basics.fst,potentialWarnings));
      return {value: A2($Basics._op["++"],
             $Basics.toString(tag),
             A2($Basics._op["++"]," ",$Basics.toString(value)))
             ,featureTagValue: Compatible
             ,warnings: warnings};
   });
   var featureTag = function (tag) {
      return A2(featureTag2,tag,1);
   };
...
Elm.Css = Elm.Css || {};
Elm.Css.Colors = Elm.Css.Colors || {};
Elm.Css.Colors.make = function (_elm) {
   "use strict";
   _elm.Css = _elm.Css || {};
   _elm.Css.Colors = _elm.Css.Colors || {};
   if (_elm.Css.Colors.values) return _elm.Css.Colors.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var silver = $Css.hex("dddddd");
   var gray = $Css.hex("AAAAAA");
   var black = $Css.hex("111111");
   var purple = $Css.hex("B10DC9");
   var fuchsia = $Css.hex("F012BE");
   var maroon = $Css.hex("85144b");
   var red = $Css.hex("FF4136");
   var orange = $Css.hex("FF851B");
   var yellow = $Css.hex("FFDC00");
   var lime = $Css.hex("01FF70");
   var green = $Css.hex("2ECC40");
   var olive = $Css.hex("3D9970");
   var teal = $Css.hex("39CCCC");
   var aqua = $Css.hex("7FDBFF");
   var blue = $Css.hex("0074D9");
   var navy = $Css.hex("001F3F");
   return _elm.Css.Colors.values = {_op: _op
                                   ,navy: navy
                                   ,blue: blue
                                   ,aqua: aqua
                                   ,teal: teal
...
Elm.Css.Namespace.make = function (_elm) {
   ...
   return _elm.Css.Namespace.values = {_op: _op
                                      ,namespace: namespace
                                      ,applyNamespaceToRepeatable: applyNamespaceToRepeatable
                                      ,applyNamespaceToSequence: applyNamespaceToSequence
                                      ,applyNamespaceToSelector: applyNamespaceToSelector
                                      ,applyNamespaceToMixin: applyNamespaceToMixin
                                      ,applyNamespaceToProperty: applyNamespaceToProperty
                                      ,applyNamespaceToStyleBlock: applyNamespaceToStyleBlock
                                      ,applyNamespaceToSnippet: applyNamespaceToSnippet
                                      ,applyNamespaceToDeclaration: applyNamespaceToDeclaration};
};
...
Elm.Matrix.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var toRowsLists = function (matrix) {
      var height = $Basics.snd(matrix.size);
      var width = $Basics.fst(matrix.size);
      return A2($List.map,
      function (columnIndex) {
         var start = columnIndex * width;
         var end = start + width;
         return $Array.toList(A3($Array.slice,start,end,matrix.data));
      },
      _U.range(0,height - 1));
   };
   var mapRowsLists = F2(function (func,matrix) {
      var lists = toRowsLists(matrix);
      return A2($List.map,func,lists);
   });
   var toRows = function (matrix) {
      var height = $Basics.snd(matrix.size);
      var width = $Basics.fst(matrix.size);
      ...
      function (columnIndex) {
         var start = columnIndex * width;
         var end = start + width;
         return A3($Array.slice,start,end,matrix.data);
      },
      _U.range(0,height - 1)));
   };
   var mapRows = F2(function (func,matrix) {
      var arrays = toRows(matrix);
      return A2($Array.map,func,arrays);
   });
   var indexedMapRows = F2(function (func,matrix) {
      var rows = toRows(matrix);
      return A2($Array.indexedMap,func,rows);
   });
   var filter = F2(function (f,matrix) {
      return A2($Array.filter,f,matrix.data);
   });
   var map2 = F3(function (f,a,b) {
      return _U.eq(a.size,b.size) ? $Maybe.Just(_U.update(a,
      {data: $Array.fromList(A3($List.map2,
      f,
      $Array.toList(a.data),
      $Array.toList(b.data)))})) : $Maybe.Nothing;
   });
   var map = F2(function (f,matrix) {
      return _U.update(matrix,
      {data: A2($Array.map,f,matrix.data)});
   });
   var concatVertical = F2(function (a,b) {
      return !_U.eq($Basics.fst(a.size),
      $Basics.fst(b.size)) ? $Maybe.Nothing : $Maybe.Just(_U.update(a,
      {size: {ctor: "_Tuple2"
             ,_0: $Basics.fst(a.size)
             ,_1: $Basics.snd(a.size) + $Basics.snd(b.size)}
      ,data: A2($Array.append,a.data,b.data)}));
   });
   var getColumn = F2(function (i,matrix) {
      var height = $Basics.snd(matrix.size);
      var width = $Basics.fst(matrix.size);
      var indices = A2($List.map,
      function (x) {
         return x * width + i;
      },
      _U.range(0,height - 1));
      return _U.cmp(i,
      width) > -1 ? $Maybe.Nothing : $Maybe.Just($Array.fromList(A3($List.foldl,
      F2(function (index,ls) {
         var _p0 = A2($Array.get,index,matrix.data);
         if (_p0.ctor === "Just") {
               return A2($Basics._op["++"],ls,_U.list([_p0._0]));
            } else {
               return ls;
            }
      }),
   ...
   var toColumns = function (matrix) {
      ...
      function (x) {
         return A2($Maybe.withDefault,
         $Array.empty,
         A2(getColumn,x,matrix));
      },
      $Array.fromList(_U.range(0,width - 1)));
   };
   var mapColumns = F2(function (func,matrix) {
      var arrays = toColumns(matrix);
      return A2($Array.map,func,arrays);
   });
   var indexedMapColumns = F2(function (func,matrix) {
      var columns = toColumns(matrix);
      return A2($Array.indexedMap,func,columns);
   });
   var toColumnsLists = function (matrix) {
      var height = $Basics.snd(matrix.size);
      var width = $Basics.fst(matrix.size);
      return A2($List.map,
      function (x) {
         return $Array.toList(A2($Maybe.withDefault,
         $Array.empty,
         A2(getColumn,x,matrix)));
      },
      _U.range(0,width - 1));
   };
   var mapColumnsLists = F2(function (func,matrix) {
      var lists = toColumnsLists(matrix);
      return A2($List.map,func,lists);
   });
   var indexedMapColumnsLists = F2(function (func,matrix) {
      var columns = toColumnsLists(matrix);
      return A2($List.indexedMap,func,columns);
   });
   var fromList = function (list) {
      var width = $List.length(function () {
      ...
      var allSame = $List.isEmpty(A2($List.filter,
      function (x) {
         return !_U.eq($List.length(x),width);
      },
      list));
      var height = $List.length(list);
      return $Basics.not(allSame) ? $Maybe.Nothing : $Maybe.Just({size: {ctor: "_Tuple2"
                                                                        ,_0: width
                                                                        ,_1: height}
                                                                 ,data: $Array.fromList($List.concat(list))});
   };
   var repeat = F3(function (x,y,v) {
      return {size: {ctor: "_Tuple2",_0: x,_1: y}
             ,data: A2($Array.repeat,x * y,v)};
   });
   var height = function (matrix) {
      return $Basics.snd(matrix.size);
   };
   var width = function (matrix) {
      return $Basics.fst(matrix.size);
   };
   var get = F3(function (i,j,matrix) {
      var pos = j * width(matrix) + i;
      return _U.cmp(i,width(matrix)) < 0 && _U.cmp(i,
      -1) > 0 && (_U.cmp(j,height(matrix)) < 0 && _U.cmp(j,
      -1) > 0) ? A2($Array.get,pos,matrix.data) : $Maybe.Nothing;
   });
   var getRow = F2(function (j,matrix) {
      var start = j * width(matrix);
      var end = start + width(matrix);
      return _U.cmp(end,
      width(matrix) * height(matrix)) > 0 ? $Maybe.Nothing : $Maybe.Just(A3($Array.slice,
      start,
      end,
      matrix.data));
   });
   var concatHorizontal = F2(function (a,b) {
      var insert = F3(function (i,xs,array) {
         return A2($Array.append,
         A2($Array.append,A3($Array.slice,0,i,array),xs),
         A3($Array.slice,i,$Array.length(array),array));
      });
      var finalWidth = $Basics.fst(a.size) + $Basics.fst(b.size);
      return !_U.eq($Basics.snd(a.size),
      $Basics.snd(b.size)) ? $Maybe.Nothing : $Maybe.Just(_U.update(a,
      {size: {ctor: "_Tuple2",_0: finalWidth,_1: $Basics.snd(a.size)}
      ,data: A3($List.foldl,
      F2(function (_p2,acc) {
         var _p3 = _p2;
      ...
      A3($List.foldl,
      F2(function (i,ls) {
         var _p4 = A2(getRow,i,a);
         if (_p4.ctor === "Just") {
               return A2($Basics._op["++"],
               ls,
               _U.list([{ctor: "_Tuple2",_0: i,_1: _p4._0}]));
            } else {
               return ls;
            }
      }),
      _U.list([]),
      _U.range(0,$Basics.snd(a.size) - 1)))}));
   });
   var set = F4(function (i,j,v,matrix) {
      var pos = j * $Basics.fst(matrix.size) + i;
      return _U.cmp(i,width(matrix)) < 0 && _U.cmp(i,
      -1) > 0 && (_U.cmp(j,height(matrix)) < 0 && _U.cmp(j,
      -1) > 0) ? _U.update(matrix,
      {data: A3($Array.set,pos,v,matrix.data)}) : matrix;
   });
   var update = F4(function (x,y,f,matrix) {
      var _p5 = A3(get,x,y,matrix);
      if (_p5.ctor === "Nothing") {
            return matrix;
         } else {
            return A4(set,x,y,f(_p5._0),matrix);
         }
   });
   var indexedMap = F2(function (f,matrix) {
      var f$ = F2(function (i,v) {
         var y = i / width(matrix) | 0;
         var x = A2($Basics._op["%"],i,width(matrix));
         return A3(f,x,y,v);
      });
      return _U.update(matrix,
      {data: $Array.fromList(A2($List.indexedMap,
      f$,
      $Array.toList(matrix.data)))});
   });
   var toIndexedArray = function (matrix) {
   ...
   var empty = {size: {ctor: "_Tuple2",_0: 0,_1: 0}
               ,data: $Array.empty};
   var Matrix = F2(function (a,b) {    return {size: a,data: b};});
   return _elm.Matrix.values = {_op: _op
                               ...
                               ,set: set
                               ,update: update
                               ,concatVertical: concatVertical
                               ,concatHorizontal: concatHorizontal
                               ...
                               ,filter: filter
                               ,mapRows: mapRows
                               ,mapRowsLists: mapRowsLists
                               ,indexedMapRows: indexedMapRows
                               ,mapColumns: mapColumns
                               ,indexedMapColumns: indexedMapColumns
                               ,indexedMapColumnsLists: indexedMapColumnsLists
                               ,toRows: toRows
                               ,toRowsLists: toRowsLists
                               ,toColumnsLists: toColumnsLists
                               ,Matrix: Matrix};
};
Elm.GridControl = Elm.GridControl || {};
Elm.GridControl.CssClasses = Elm.GridControl.CssClasses || {};
Elm.GridControl.CssClasses.make = function (_elm) {
   "use strict";
   _elm.GridControl = _elm.GridControl || {};
   _elm.GridControl.CssClasses = _elm.GridControl.CssClasses || {};
   if (_elm.GridControl.CssClasses.values)
   return _elm.GridControl.CssClasses.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var namespace = "ElmGridControl";
   var _p0 = $Html$CssHelpers.withNamespace(namespace);
   var id = _p0.id;
   var $class = _p0.$class;
   var classList = _p0.classList;
   var NotDraggable = {ctor: "NotDraggable"};
   var Active = {ctor: "Active"};
   var Cell = {ctor: "Cell"};
   var Column = {ctor: "Column"};
   var ColumnGroup = {ctor: "ColumnGroup"};
   var Grid = {ctor: "Grid"};
   return _elm.GridControl.CssClasses.values = {_op: _op
                                               ,Grid: Grid
...
Elm.GridControl = Elm.GridControl || {};
Elm.GridControl.Cell = Elm.GridControl.Cell || {};
Elm.GridControl.Cell.make = function (_elm) {
   "use strict";
   _elm.GridControl = _elm.GridControl || {};
   _elm.GridControl.Cell = _elm.GridControl.Cell || {};
   if (_elm.GridControl.Cell.values)
   return _elm.GridControl.Cell.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $GridControl$CssClasses = Elm.GridControl.CssClasses.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var update = F3(function (action,params,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "MouseEnter": return params.mouseDown ? true : model;
         case "MouseLeave": return model;
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([A2($Html$Events.onMouseDown,address,MouseDown)
              ,A2($Html$Events.onMouseEnter,address,MouseEnter)
              ,A2($Html$Events.onMouseLeave,address,MouseLeave)
              ,$GridControl$CssClasses.classList(_U.list([{ctor: "_Tuple2"
                                                          ,_0: $GridControl$CssClasses.Cell
                                                          ,_1: true}
                                                         ,{ctor: "_Tuple2"
                                                          ,_0: $GridControl$CssClasses.NotDraggable
                                                          ,_1: true}
                                                         ,{ctor: "_Tuple2"
                                                          ,_0: $GridControl$CssClasses.Active
                                                          ,_1: model}]))]),
      _U.list([]));
   });
   var UpdateParams = function (a) {    return {mouseDown: a};};
   var set = function (model) {    return model;};
   var init = function (model) {    return model;};
   return _elm.GridControl.Cell.values = {_op: _op
                                         ,init: init
                                         ,update: update
                                         ,view: view
...
Elm.GridControl = Elm.GridControl || {};
Elm.GridControl.ListExtra = Elm.GridControl.ListExtra || {};
Elm.GridControl.ListExtra.make = function (_elm) {
   "use strict";
   _elm.GridControl = _elm.GridControl || {};
   _elm.GridControl.ListExtra = _elm.GridControl.ListExtra || {};
   if (_elm.GridControl.ListExtra.values)
   return _elm.GridControl.ListExtra.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var splitByN = F2(function (length,list) {
      if (_U.cmp(length,0) > 0) {
            var _p0 = {ctor: "_Tuple2"
                      ,_0: A2($List.take,length,list)
                      ,_1: A2($List.drop,length,list)};
            if (_p0._1.ctor === "[]") {
                  if (_p0._0.ctor === "[]") {
                        return _U.list([]);
                     } else {
                  ...
                  return A2($List._op["::"],_p0._0,A2(splitByN,length,_p0._1));
               }
         } else return _U.list([]);
   });
   return _elm.GridControl.ListExtra.values = {_op: _op
                                              ,splitByN: splitByN};
};
Elm.GridControl = Elm.GridControl || {};
Elm.GridControl.make = function (_elm) {
   "use strict";
   _elm.GridControl = _elm.GridControl || {};
   if (_elm.GridControl.values) return _elm.GridControl.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $GridControl$Cell = Elm.GridControl.Cell.make(_elm),
   $GridControl$CssClasses = Elm.GridControl.CssClasses.make(_elm),
   $GridControl$ListExtra = Elm.GridControl.ListExtra.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Events = Elm.Html.Events.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "MouseLeave": return _U.update(model,
           {currColumnIndex: $Maybe.Nothing,mouseDown: false});
         case "MouseLeaveColumn": return _U.update(model,
           {currColumnIndex: $Maybe.Nothing});
         case "CellAction": var _p4 = _p0._0;
           var _p3 = _p0._1;
           var _p1 = _p3;
           switch (_p1.ctor)
           {case "MouseEnter": var _p2 = model.mouseDown;
                if (_p2 === false) {
                      return model;
                   } else {
                      var getValue = F3(function (x,y,val) {
                         return _U.eq(x,_p4.x) ? _U.eq(y,_p4.y) ? true : false : val;
                      });
                      var newCells = A2($Matrix.indexedMap,getValue,model.cells);
                      return _U.update(model,
                      {cells: newCells,currColumnIndex: $Maybe.Just(_p4.x)});
                   }
              case "MouseDown": var getValue = F3(function (x,y,val) {
                   return _U.eq(x,_p4.x) ? _U.eq(y,
                   _p4.y) ? $Basics.not(val) : false : val;
                });
                var newCells = A2($Matrix.indexedMap,getValue,model.cells);
                return _U.update(model,
                {cells: newCells,currColumnIndex: $Maybe.Just(_p4.x)});
              default: var cellModel = A2($Matrix.get,_p4.x,_p4.y);
                return _U.update(model,
                {cells: A4($Matrix.update,
                _p4.x,
                _p4.y,
                A2($GridControl$Cell.update,_p3,{mouseDown: model.mouseDown}),
                model.cells)});}
         case "MouseDown": return _U.update(model,{mouseDown: true});
         default: return _U.update(model,{mouseDown: false});}
   });
   var CellAction = F2(function (a,b) {
      return {ctor: "CellAction",_0: a,_1: b};
   });
   var MouseLeaveColumn = function (a) {
      return {ctor: "MouseLeaveColumn",_0: a};
   };
   var columnView = F3(function (address,x,column) {
      return A2($Html.div,
      _U.list([$GridControl$CssClasses.$class(_U.list([$GridControl$CssClasses.Column]))
              ,A2($Html$Events.onMouseLeave,address,MouseLeaveColumn(x))]),
      A2($List.indexedMap,
      F2(function (y,cell) {
         return A2($GridControl$Cell.view,
         A2($Signal.forwardTo,address,CellAction({x: x,y: y})),
         cell);
      }),
      column));
   });
   ...
   var MouseDown = {ctor: "MouseDown"};
   var view = F3(function (params,address,model) {
      var columnGroupView = F2(function (address,model) {
         return A2($Html.div,
         _U.list([$GridControl$CssClasses.$class(_U.list([$GridControl$CssClasses.ColumnGroup]))]),
         A2($List.indexedMap,
         F2(function (i,column) {
            return A3(columnView,
            address,
      ...
      var columnGroups = A2($GridControl$ListExtra.splitByN,
      params.columnGroupLength,
      $Matrix.toColumnsLists(model.cells));
      return A2($Html.div,
      _U.list([$GridControl$CssClasses.$class(_U.list([$GridControl$CssClasses.Grid]))
              ,A2($Html$Events.onMouseDown,address,MouseDown)
              ,A2($Html$Events.onMouseUp,address,MouseUp)
              ,A2($Html$Events.onMouseLeave,address,MouseLeave)]),
      A2($List.indexedMap,
      F2(function (i,columnGroup) {
         return A2(columnGroupView,
         address,
         {columnGroup: columnGroup,groupIndex: i});
      }),
      columnGroups));
   });
   var init = F2(function (width,height) {
      return {cells: A3($Matrix.repeat,
             width,
             height,
             $GridControl$Cell.init(false))
             ,mouseDown: false
             ,currColumnIndex: $Maybe.Nothing};
   });
   var Model = F3(function (a,b,c) {
      return {cells: a,mouseDown: b,currColumnIndex: c};
   });
   return _elm.GridControl.values = {_op: _op
                                    ,Model: Model
                                    ,init: init
                                    ,MouseDown: MouseDown
                                    ,MouseUp: MouseUp
                                    ,MouseLeave: MouseLeave
                                    ,MouseLeaveColumn: MouseLeaveColumn
...
Elm.GridControl = Elm.GridControl || {};
Elm.GridControl.DefaultCss = Elm.GridControl.DefaultCss || {};
Elm.GridControl.DefaultCss.make = function (_elm) {
   "use strict";
   _elm.GridControl = _elm.GridControl || {};
   _elm.GridControl.DefaultCss = _elm.GridControl.DefaultCss || {};
   if (_elm.GridControl.DefaultCss.values)
   return _elm.GridControl.DefaultCss.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Css = Elm.Css.make(_elm),
   $Css$Colors = Elm.Css.Colors.make(_elm),
   ...
   var css = function (_p0) {
      ...
      $GridControl$CssClasses.namespace,
      _p0));
   }(_U.list([A2(F2(function (x,y) {
                return A2($Css._op["."],x,y);
             }),
             $GridControl$CssClasses.Grid,
             _U.list([$Css.displayFlex
                     ,$Css.width($Css.pct(100))
                     ,$Css.height($Css.pct(100))
                     ,A3($Css.border3,$Css.px(1),$Css.solid,A3($Css.rgb,255,255,255))
                     ,A2($Css.property,"cursor","default")]))
             ,A2(F2(function (x,y) {    return A2($Css._op["."],x,y);}),
             $GridControl$CssClasses.ColumnGroup,
             _U.list([$Css.displayFlex
                     ,$Css.flexDirection($Css.row)
                     ,A2($Css.property,"flex","1")
                     ,A3($Css.borderLeft3,
                     $Css.px(5),
                     $Css.solid,
                     A3($Css.rgb,255,255,255))]))
             ,A2(F2(function (x,y) {    return A2($Css._op["."],x,y);}),
             $GridControl$CssClasses.Column,
             _U.list([$Css.displayFlex
                     ...
                     $Css.solid,
                     A3($Css.rgb,255,255,255))
                     ,A3($Css.borderBottom3,
                     $Css.px(5),
                     $Css.solid,
                     A3($Css.rgb,255,255,255))]))
             ,A2(F2(function (x,y) {    return A2($Css._op["."],x,y);}),
             $GridControl$CssClasses.Cell,
             _U.list([A2($Css.property,"flex","1")
                     ,$Css.margin($Css.px(1))
                     ,$Css.backgroundColor(A4($Css.rgba,0,0,0,5.0e-2))]))
             ,A2(F2(function (x,y) {    return A2($Css._op["."],x,y);}),
             $GridControl$CssClasses.Active,
             _U.list([$Css.backgroundColor($Css$Colors.teal)]))
             ,A2(F2(function (x,y) {    return A2($Css._op["."],x,y);}),
             $GridControl$CssClasses.NotDraggable,
             _U.list([A2($Css.property,"user-drag","none")
                     ,A2($Css.property,"user-select","none")
                     ,A2($Css.property,"-webkit-user-drag","none")
                     ,A2($Css.property,"-webkit-user-select","none")]))]));
   var stylesText = function (_) {
      return _.css;
   }($Css.compile(css));
   var rawBlock = function (s) {
      var parseDeclaration = function (rawDeclaration) {
         var _p1 = A2($String.split,":",rawDeclaration);
         if (_p1.ctor === "::" && _p1._1.ctor === "::" && _p1._1._1.ctor === "[]")
         {
               return $Maybe.Just(A2($Css.property,_p1._0,_p1._1._0));
            } else {
               return $Maybe.Nothing;
            }
      };
   ...
   return _elm.GridControl.DefaultCss.values = {_op: _op
                                               ,rawBlock: rawBlock
                                               ,css: css
...
Elm.Main.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $GridControl = Elm.GridControl.make(_elm),
   $GridControl$DefaultCss = Elm.GridControl.DefaultCss.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   ...
   var _op = {};
   var styleNode = function (cssString) {
      return A3($Html.node,
      "style",
      _U.list([]),
      _U.list([$Html.text(cssString)]));
   };
   var demoStylesText = "\n  /* apply a natural box layout model to all elements, but allowing components to change */\n  html {\n    box-sizing: border-box;\n  }\n  *, *:before, *:after {\n    box-sizing: inherit;\n  }\n\n  html, head, body, body > div, .demo {\n    height: 100%;\n    width: 100%;\n  }\n\n  .demo {\n    max-width: 800px;\n    max-height: 400px;\n  }\n";
   var view = F2(function (action,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("demo")]),
      _U.list([styleNode(A2($Basics._op["++"],
              demoStylesText,
              $GridControl$DefaultCss.stylesText))
              ,A3($GridControl.view,{columnGroupLength: 4},action,model)]));
   });
   var main = $StartApp$Simple.start({model: A2($GridControl.init,
                                     16,
                                     12)
                                     ,view: view
