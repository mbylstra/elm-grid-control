...
Elm.Matrix.make = function (_elm) {
   ...
   var toColumns = function (matrix) {
      ...
      $Array.fromList(_U.range(0,width)));
   };
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html$Events.onMouseDown,address,MouseDown)
              ...
              ,$Html$Attributes.classList(_U.list([{ctor: "_Tuple2"
                                                   ,_0: "cell"
                                                   ,_1: true}
                                                  ,{ctor: "_Tuple2",_0: "active",_1: model}]))]),
      _U.list([]));
   });
...
Elm.GridControl.make = function (_elm) {
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("grid")
              ,A2($Html$Events.onMouseDown,address,MouseDown)
              ,A2($Html$Events.onMouseUp,address,MouseUp)
              ,A2($Html$Events.onMouseLeave,address,MouseLeave)]),
      A2($Matrix.indexedMapColumnsLists,
      F2(function (x,column) {
         return A3(columnView,address,x,column);
      }),
      model.cells));
   });
...
Elm.Main.make = function (_elm) {
   ...
   var view = F2(function (action,model) {
      ...
      _U.list([styleNode("\n        body {\n          padding: 40px;\n          font-family: \'Montserrat\', Arial, serif; font-weight: 400;\n          -webkit-touch-callout: none;\n          -webkit-user-select: none;\n          -khtml-user-select: none;\n          -moz-user-select: none;\n          -ms-user-select: none;\n          user-select: none;\n        }\n        h2 {\n          font-family: \'Montserrat\', Arial, serif; font-weight: 700;\n        }\n        .grid {\n          cursor: default;\n          display: flex;\n          width: 200px;\n          height: 200px;\n          border: 2px solid black;\n        }\n        .cell {\n          width: 20px;\n          height: 20px;\n          /* border: 1px solid white; */\n        }\n        .cell.active {\n          background-color: rgba(255, 0, 0, 0.4);\n        }\n      ")
              ,A2($GridControl.view,action,model)]));
   });
